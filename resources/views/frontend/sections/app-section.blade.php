            ...
            <div class="col-lg-5 pb-30">
                <div class="app-btn-wrapper">
                    <a href="{{ $app_settings->android_url ?? '' }}" class="app-btn" target="_blank">
                        <div class="app-icon">
                            <img src="{{ asset('public/frontend/assets/images/icon/play-store.webp') }}" alt="icon">
                        </div>
                        <div class="content">
                        ...
                        <div class="icon">
                            <img src="{{ asset('public/frontend/assets/images/element/qr-icon.webp') }}" alt="element">
                        </div>
                        <div class="app-qr">
                            <img src="{{ asset('public/frontend/assets/images/element/play-qr.webp') }}" alt="element">
                        </div>
                    </a>
                    <a href="{{ $app_settings->iso_url ?? '' }}" class="app-btn" target="_blank">
                        <div class="app-icon">
                            <img src="{{ asset('public/frontend/assets/images/icon/apple-store.webp') }}" alt="icon">
                        </div>
                        <div class="content">
                        ...
                        <div class="app-qr">
                            <img src="{{ asset('public/frontend/assets/images/element/app-qr.webp') }}" alt="element">
                        </div>
                    </a>
                </div>
            </div>
