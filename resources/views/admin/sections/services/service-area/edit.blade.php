...
@section('breadcrumb')
    @include('admin.components.breadcrumb',['breadcrumbs' => [
        ...
        [
            ...
            'url'   => setRoute("admin.service.area.index")
        ]
    ], 'active' => __("Service Area Edit")])
@endsection
...
<div class="custom-card">
    ...
    <div class="card-body">
        <form class="card-form" action="{{ setRoute('admin.service.area.update',$area->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            <div class="row mb-10-none">
                ...
                <div class="col-xl-12 col-lg-12 form-group">
                    @php
                        $area_type_ids = $area->types->pluck('service_type_id')->toArray();
                    @endphp
